...
- Match platform norms: X hooks read like the start of a tweet (no headline-formatting); LinkedIn hooks read like the first line a recruiter or founder would see in their feed.
- Never use em dashes (—) or en dashes (–). Use a period, comma, colon, or line break instead.`;
